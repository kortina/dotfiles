    ...
    def setup(cls):
        ...
        md = {
            ...
            "email_blacklist": (
                ...
                "daemon|devops|@docs\.|document|docusign|"
                "@e\.|email@|etrade|events*@|"
                "filmfest@|feedback|festival@|filings@|@fin\.com|@finxpc\.com|@fin\.ventures|followup|forums*@|"
                "getfin\.|giving@|googlegroups|googlenest|"
                "hello@|help|"
                "id\.apple\.com|iftt|info@|info\.|^ir@|"
                "@inside\.garmin\.com|invest@|invoice|"
                "jetblueairways|"
                "legal@|@letter\.ly|lexisnexis|listening\.id\.me|@lists*\."
                "mailgun|mail\.vresp|mail\.comms\.yahoo\.net|marketing|@member|members*@|microsoft@|@mms\.att"
                ...
                "security|securemessag|service|^sff@|@soul-|statement|status@|submissions*@|"
