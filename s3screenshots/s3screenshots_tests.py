...
class S3ScreenshotHandlerTests(TestCase):
    ...
    def test_new_filename(self):
        ...
        self.assertEqual(i._new_filename("Screen Shot 2017-03-19 at 6.52.13 PM.png"),
    ...
    def test_new_filepath(self):
        ...
        r = 'abcdbcdefgh'
        i._random_suffix = MagicMock(return_value=r)
        self.assertEqual(i._new_filepath("/Users/kortina/Desktop/Screen Shot 2017-03-19 at 6.52.13 PM.png"),
